...
RUN wget https://github.com/peazip/PeaZip/releases/download/8.0.0/peazip_8.0.0.LINUX.x86_64.GTK2.deb
RUN sudo gdebi -n peazip_8.0.0.LINUX.x86_64.GTK2.deb
RUN sudo rm -f peazip_8.0.0.LINUX.x86_64.GTK2.deb
